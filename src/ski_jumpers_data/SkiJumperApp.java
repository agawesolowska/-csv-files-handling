...
public class SkiJumperApp {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"AUT - Austria , FIN - Finlandia, GER - Niemcy, NOR - Norwegia, POL - Polska, USA - Stany Zjednoczone");

		RepresentedCountry country = RepresentedCountry.valueOf(sc.nextLine());
		System.out.println("Wybrani skoczkowie ważą łącznie: "
				+ CsvFileHandling.totalWeightOfRepresentatives(skiJumperList, country) + " kg.\n");
